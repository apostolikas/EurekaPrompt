...
aqua_initial_prompts = [
    ...
    "Slow down, let's break this down into manageable steps",
    "Inhale deeply, exhale slowly, and embark on this problem-solving journey with a step-by-step mindset",
    "Let's dive in this challenge and find the right answer",
    "You can do this! Be careful in the calculations."
]

aqua_inference_prompts = [
    "",
    "This is very important to my career",
    "Let's think step by step",
    "Let's first understand the problem and devise a plan to solve the problem. Then, let's carry out the plan and solve the problem step by step",
...
aqua_mutation_styles = [
    "The mutation is a short and simple variant of the input prompt that introduces a structured thought process.",
    "The mutation is a short and simple variant of the input prompt that promotes correctness and inspiration.",
    # "The mutation is a short and simple variant of the input prompt that ensures accuracy in calculations and swift problem-solving.",
    "The mutation is a variant of the input prompt that promotes positive attitude and strategic thinking.",
    # "The mutation is a variant of the input prompt that promotes mathematical reasoning and scientific thinking.",
    "Through mutation, the prompt is altered to showcase motivation and logical reasoning.",
    "The mutation changes the input prompt to emphasize on precision and quickness.",
    "The mutation is a changed version of the prompt with more detailed steps to solve the problem.",
]
